...
@XmlRootElement(name = "TransformQueryItemUsage", namespace = "http://www.developer.cognos.com/schemas/fmsdk/1/0")
public class TransformQueryItemUsage
    extends Action
{

    @XmlElement(namespace = "http://www.developer.cognos.com/schemas/fmsdk/1/0", required = true)
    protected TransformQueryItemUsage.InputParams inputParams;
     ...
     * @return
     *     possible object is
     *     {@link TransformQueryItemUsage.InputParams }
     *     
     */
    public TransformQueryItemUsage.InputParams getInputParams() {
        return inputParams;
    }
     ...
     *     
     */
    public void setInputParams(TransformQueryItemUsage.InputParams value) {
